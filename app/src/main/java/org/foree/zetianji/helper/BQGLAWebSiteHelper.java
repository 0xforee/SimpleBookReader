 ...
 * 小说的数据来源
 */
public class BQGLAWebSiteHelper extends AbsWebSiteHelper{
    private static final String TAG = BQGLAWebSiteHelper.class.getSimpleName();
    private String websiteCharSet = "gbk";
    private String host_url = "http://www.biquge.la";
    private String index_page="/book/168/";
